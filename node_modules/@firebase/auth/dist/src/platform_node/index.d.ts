...
export declare const browserLocalPersistence: import("@firebase/app").FirebaseError;
export declare const browserSessionPersistence: import("@firebase/app").FirebaseError;
export declare const indexedDBLocalPersistence: import("@firebase/app").FirebaseError;
